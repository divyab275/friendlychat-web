# Contributing to the Hack Kochi Chat App

We'd love for you to contribute to our source code and to make the Hack Kochi Chat App even better than it is today! Here are the guidelines we'd like you to follow:
...
As contributors and maintainers of the Hack Kochi Chat App, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.
...
If you have questions about how to use the Hack Kochi Chat App, please direct these to [StackOverflow][stackoverflow] and use the `firebase` tag. We are also available on GitHub issues.
